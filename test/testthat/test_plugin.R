...
APE = average_partial_effect(X, Y, W, balance.method = "plugin")
...
test_that("plugin estimator is scale invariant", {
    expect_equal(APEaWY["point.estimate"], APE["point.estimate"], tolerance = 0.05)
    expect_equal(APEaWY["standard.error.estimate"], APE["standard.error.estimate"], tolerance = 0.02)
})
